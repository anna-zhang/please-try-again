...
cards = [
  ...
  Card(6, "Share a photo that makes you happy.", "There must be a person in the photo.", ["photo"]), 
  Card(7, "Share a photo of a place you've been to. ", "The photo must be in black and white.", ["photo"]), 
  Card(8, "Share a photo from a day with nice weather.", "It must be a photo of a sunset or sunrise.", ["photo"]), 
  Card(9, "Share a photo of an activity that you did this weekend.", "It must be a nighttime photo.", ["photo"]), 
  ...
  Card(13, "Where do you see yourself in the future?", "It must be an interior space.", ["photo"]), 
  Card(13, "Where do you see yourself in the future?", "It must be an interior space.", ["photo"]), 
